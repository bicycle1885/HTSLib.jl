...
@defun fai_destroy(fai::Ref{faidx_t})::Cvoid
...
@defun fai_fetch(fai::Ref{faidx_t}, reg::Cstring, len::Ref{Cint})::Ptr{Cchar}

# char *fai_fetch64(const faidx_t *fai, const char *reg, hts_pos_t *len);
@defun fai_fetch64(fai::Ref{faidx_t}, reg::Cstring, len::Ref{hts_pos_t})::Ptr{Cchar}

# char *fai_fetchqual(const faidx_t *fai, const char *reg, int *len);
@defun fai_fetchqual(fai::Ref{faidx_t}, reg::Cstring, len::Ref{Cint})::Ptr{Cchar}

# char *fai_fetchqual64(const faidx_t *fai, const char *reg, hts_pos_t *len);
@defun fai_fetchqual64(fai::Ref{faidx_t}, reg::Cstring, len::Ref{hts_pos_t})::Ptr{Cchar}

# int faidx_fetch_nseq(const faidx_t *fai) HTS_DEPRECATED("Please use faidx_nseq instead");
@defun faidx_fetch_nseq(fai::Ref{faidx_t})::Cint

# char *faidx_fetch_seq(const faidx_t *fai, const char *c_name, int p_beg_i, int p_end_i, int *len);
@defun faidx_fetch_seq(fai::Ref{faidx_t}, c_name::Cstring, p_beg_i::Cint, p_end_i::Cint, len::Ref{Cint})::Ptr{Cchar}

# char *faidx_fetch_seq64(const faidx_t *fai, const char *c_name, hts_pos_t p_beg_i, hts_pos_t p_end_i, hts_pos_t *len);
@defun faidx_fetch_seq64(fai::Ref{faidx_t}, c_name::Cstring, p_beg_i::hts_pos_t, p_end_i::hts_pos_t, len::Ref{hts_pos_t})::Ptr{Cchar}

# char *faidx_fetch_qual(const faidx_t *fai, const char *c_name, int p_beg_i, int p_end_i, int *len);
@defun faidx_fetch_qual(fai::Ref{faidx_t}, c_name::Cstring, p_beg_i::Cint, p_end_i::Cint, len::Ref{Cint})::Ptr{Cchar}

# char *faidx_fetch_qual64(const faidx_t *fai, const char *c_name, hts_pos_t p_beg_i, hts_pos_t p_end_i, hts_pos_t *len);
@defun faidx_fetch_qual64(fai::Ref{faidx_t}, c_name::Cstring, p_beg_i::hts_pos_t, p_end_i::hts_pos_t, len::Ref{hts_pos_t})::Ptr{Cchar}

# int faidx_has_seq(const faidx_t *fai, const char *seq);
@defun faidx_has_seq(fai::Ref{faidx_t}, seq::Cstring)::Cint

# int faidx_nseq(const faidx_t *fai);
@defun faidx_nseq(fai::Ref{faidx_t})::Cint

# const char *faidx_iseq(const faidx_t *fai, int i);
@defun faidx_iseq(fai::Ref{faidx_t}, i::Cint)::Cstring

# int faidx_seq_len(const faidx_t *fai, const char *seq);
@defun faidx_seq_len(fai::Ref{faidx_t}, seq::Cstring)::Cint

# const char *fai_parse_region(const faidx_t *fai, const char *s, int *tid, hts_pos_t *beg, hts_pos_t *end, int flags);
@defun fai_parse_region(fai::Ref{faidx_t}, s::Cstring, tid::Ref{Cint}, beg::Ref{hts_pos_t}, end_::Ref{hts_pos_t}, flags::Cint)::Cstring

# void fai_set_cache_size(faidx_t *fai, int cache_size);
@defun fai_set_cache_size(fai::Ref{faidx_t}, cache_size::Cint)::Cvoid
